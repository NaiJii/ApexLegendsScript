...
void function InitADSMotionControlsPanelConsole( var panel )
{
	...
	file.customItems.extend( SetupSettingsSlider( Hud_GetChild( contentPanel, "SldMotionSensitivityADS1" ), "#PEROPTICADS_1", "#GAMEPAD_MENU_SENSITIVITY_ZOOM_DESC_2x", $"" ) )
	file.customItems.extend( SetupSettingsSlider( Hud_GetChild( contentPanel, "SldMotionSensitivityADS2" ), "#PEROPTICADS_2", "#GAMEPAD_MENU_SENSITIVITY_ZOOM_DESC_3x", $"" ) )
	...
	file.customItems.extend( SetupSettingsSlider( Hud_GetChild( contentPanel, "SldMotionSensitivityADS5" ), "#PEROPTICADS_5", "#GAMEPAD_MENU_SENSITIVITY_ZOOM_DESC_8x", $"" ) )
